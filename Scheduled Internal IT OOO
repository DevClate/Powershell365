...
#Email body doesn't pull date from Start/End time yet, needs to be manually inputted for now, you could setup another paramter without time and just don't though
...
param (
    ...
    [string]
    $ExtHelp,
    $InternalMessage = "Thank you for your email. I will be out of the office Friday, 4/15 with a return date of Monday, 4/18. If your email is of urgent nature, please contact the help desk at extension $ExtHelp. If you need immediate assistance, please contact $ManagerName at extension $Ext. Thank you."
